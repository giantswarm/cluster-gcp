...
{{- define "controlplane-kubeadmcontrolplane-spec" -}}
...
spec:
  machineTemplate:
    ...
    infrastructureRef:
      ...
      name: {{ include "resource.default.name" $ }}-{{ include "hash" (dict "data" (include "controlplane-gcpmachinetemplate-spec" $) "global" .) }}
